...
def main() -> int:
    ...
    parser.add_argument("--output-dir", default="results_versioned/programmer_v2_final")
    parser.add_argument("--figures-dir", default="figures_versioned/programmer_v2_final")
    parser.add_argument(
